...
background.initializr = function() {
  ...
  $this.object = $(
    "<div style='z-index:-1;background:#0093b5;margin:0;padding:0;top:0;overflow:hidden;position:absolute;bottom:0' id='" +
      $this.id +
      "'> </div>'"
  ).appendTo("body");

  $this.ww = $(window).width();
  $this.wh = $("#main_bubble").height();
  ...
  for (var i = 0; i < $this.bubbles_number; i++) {
    $this.generate_bubbles();
  }
};
// function getColor() {
//   const colors = ['#ff9d88', '#38c0fc','#cdd6d5'];
